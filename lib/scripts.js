...
jQuery(document).ready(function ($) {
  ...
  if (window.location.pathname.includes("arte.html")) excelFilePath = "arte_tarde_502.xlsx";
  else if (window.location.pathname.includes("artv.html")) excelFilePath = "artv.xlsx";
  ...
  else if (window.location.pathname.includes("edfis.html")) excelFilePath = "edfis_502.xlsx";
  ...
  else if (window.location.pathname.includes("fis.html")) excelFilePath = "fisica_502.xlsx";
  else if (window.location.pathname.includes("geo.html")) excelFilePath = "geo_tarde_502.xlsx";
  else if (window.location.pathname.includes("hist.html")) excelFilePath = "hist_tarde_502.xlsx";
  else if (window.location.pathname.includes("home.html")) excelFilePath = "501pra_manha.xlsx";
  ...
  else if (window.location.pathname.includes("intl.html")) excelFilePath = "intl.xlsx";
  else if (window.location.pathname.includes("libras.html")) excelFilePath = "libras.xlsx";
  else if (window.location.pathname.includes("mat.html")) excelFilePath = "mat_tarde_502.xlsx";
  else if (window.location.pathname.includes("musica.html")) excelFilePath = "musica_500.xlsx";
  else if (window.location.pathname.includes("port.html")) excelFilePath = "port_tarde_502.xlsx";
  ...
  else if (window.location.pathname.includes("teatro.html")) excelFilePath = "teatro.xlsx";
