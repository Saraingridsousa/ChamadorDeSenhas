...
jQuery(document).ready(function ($) {
  ...
  else if (window.location.pathname.includes("artv.html")) excelFilePath = "artv_tarde_500.xlsx";
  ...
  else if (window.location.pathname.includes("intl.html")) excelFilePath = "intl_tarde_500.xlsx";
  else if (window.location.pathname.includes("libras.html")) excelFilePath = "libras_tarde_500.xlsx";
