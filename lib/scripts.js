...
jQuery(document).ready(function ($) {
  ...
  } else if (window.location.pathname.includes("artv.html")) { // Link da página na qual a planilha vai
    excelFilePath = "artv.xlsx"; // Link para planilhas
