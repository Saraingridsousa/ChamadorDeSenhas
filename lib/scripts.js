...
jQuery(document).ready(function ($) {
  ...
  if (window.location.pathname.includes("arte.html")) excelFilePath = "arte.xlsx";
  ...
  else if (window.location.pathname.includes("danca.html")) excelFilePath = "danca_500.xlsx";
  ...
  else if (window.location.pathname.includes("musica.html")) excelFilePath = "musica.xlsx";
  else if (window.location.pathname.includes("port.html")) excelFilePath = "port.xlsx";
