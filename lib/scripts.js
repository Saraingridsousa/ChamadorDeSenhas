...
jQuery(document).ready(function ($) {
  ...
  if (window.location.pathname.includes("arte.html")) {
    excelFilePath = "arte_tarde_502.xlsx";
    ...
    excelFilePath = "ciencias_502.xlsx";
  } else if (window.location.pathname.includes("cooped.html")) {
    excelFilePath = "cooped_499.xlsx";
  ...
  $("body").on("keydown", function (e) {
    ...
    // Definir número do guichê com teclas numéricas (1-9)
    if (e.key >= "1" && e.key <= "9") {
